...
?>
<div id="slider-<?= $slider_id ?>" class="carousel slide w-100" data-bs-ride="true" data-bs-interval="<?= $interval ?>" data-bs-pause="false">
    ...
    <?php if ($nav) : ?>
        <a class="carousel-control-prev opacity-100" data-bs-target="#slider-<?= $slider_id ?>" role="button" data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        </a>
        <a class="carousel-control-next opacity-100" data-bs-target="#slider-<?= $slider_id ?>" role="button" data-bs-slide="next">
