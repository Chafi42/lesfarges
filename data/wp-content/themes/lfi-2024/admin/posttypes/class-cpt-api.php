...
if (!class_exists('CPT_API')) {
    ...
    {
        /**
         * The names passed to the CPT_API
         * @var array
         */
        public $names;

        /**
         * The name for the CPT_API
         * @var array
         */
        public $name;

        /**
         * The singular for the CPT_API
         * @var array
         */
        public $singular;

        /**
         * The plural name for the CPT_API
         * @var array
         */
        public $plural;

        /**
         * The slug for the CPT_API
         * @var array
         */
        public $slug;

        /**
         * Options for the CPT_API
         * @var array
         */
        public $options;

        /**
         * Labels for the CPT_API
         * @var array
         */
        public $labels;

        /**
         * Taxonomies for the CPT_API
         * @var array
         */
        public $taxonomies = [];

        /**
         * Filters for the CPT_API
         * @var mixed
         */
        public $filters;

        /**
         * The menu icon for the CPT_API
         * @var string
         */
        public $icon;

        /**
         * The column manager for the CPT_API
         * @var mixed
         */
        public $columns;
         ...
         * @param array $options An array of options for the CPT_API
         */
        public function __construct($names, $options = [], $labels = [])
        {
            // assign names to the CPT_API
            $this->names($names);

            // assign custom options to the CPT_API
            $this->options($options);

            // assign labels to the CPT_API
            $this->labels($labels);
        }

        /**
         * Set the names for the CPT_API
         * @param  mixed $names A string for the name, or an array of names
         * @return $this
         */
        ...
        /**
         * Set the options for the CPT_API
         * @param  array $options An array of options for the CPT_API
         * @return $this
         */
        ...
        /**
         * Set the labels for the CPT_API
         * @param  array $labels An array of labels for the CPT_API
         * @return $this
         */
        ...
        /**
         * Set the menu icon for the CPT_API
        ...
        /**
         * Get the Column Manager for the CPT_API
         * @return CPT_API_Cols
         */
        ...
        {
            // register the CPT_API
            add_action('init', [&$this, 'registerPostType']);

            // register Taxonomies to the CPT_API
        ...
        {
            // create options for the CPT_API
        ...
        /**
         * Create the required names for the CPT_API
         * @return void
         */
        public function createNames()
        {
            // names required for the CPT_API
            $required = [
                'name',
                'singular',
                'plural',
        ...
        /**
         * Create the labels for the CPT_API
         * @return array
         */
        ...
        {
            // first check we are working with the this CPT_API
        ...
        /**
         * Calculate the filters for the CPT_API
         * @return array
         */
        public function getFilters()
        {
            ...
            // Taxonomies assigned to the CPT_API
            if (is_null($this->filters) && !empty($this->taxonomies)) {
                // create filters for each taxonomy assigned to the CPT_API
        ...
        /**
         * Modify the columns for the CPT_API
        ...
        /**
         * Populate custom columns for the CPT_API
