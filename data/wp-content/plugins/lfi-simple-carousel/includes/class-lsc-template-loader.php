...
if (!class_exists('LSC_Template_Loader')) {


    /**
     * Template Loader for Plugins.
     *
     * @package   LSC_Template_Loader
     * @author    Gary Jones
    ...
    class LSC_Template_Loader
    {
         ...
         * @type string
         */
        protected $filter_prefix = 'lfi_simple_carousel';
         ...
         * @type string
         */
        protected $theme_template_directory = 'lfi-simple-carousel'; // or 'your-plugin-templates' etc.
         ...
         * @type string
         */
        protected $plugin_directory = LSC_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
         ...
         * @since 1.0.0
         *
         * @uses LSC_Template_Loader::get_template_possble_parts() Create file names of templates.
         * @uses LSC_Template_Loader::locate_template() Retrieve the name of the highest priority template
         *     file that exists.
         *
         * @param string  $slug
         ...
         * @param $args array Additional arguments passed to the template.
         *
         * @return string The template filename if one is located.
         */
        protected function locate_template($template_names, $load = false, $require_once = true, $args = array())
        {
            // No file found yet
            $located = false;
