...
if (!class_exists('LSC_Settings_API_Menu')) {

    /**
     * LSC_Settings_API_Menu
     *
    ...
    class LSC_Settings_API_Menu extends LSC_Settings_API
    {
        ...
        public function __construct($options = array())
        {
            ...
            add_action('LSC_Settings_API_Menu_page_save_' . $this->menu_slug, array($this, 'save_settings'));
        }
        ...
        public function admin_enqueue_scripts($hook_suffix)
        {
            ...
            $path = $helper->get_uri_path('admin/');
            $cssPath = $path . 'css/';
            $jsPath = $path . 'js/';
        ...
        protected function save_if_submit()
        {
            if (isset($_POST[$this->menu_slug . '_save'])) {
                do_action('LSC_Settings_API_Menu_page_save_' . $this->menu_slug);
            }
        }
    }
}
